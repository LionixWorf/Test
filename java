...
/*
   client.user.setPresence({ game: { name: 'comando', type: 1, url: 'https://discord.gg/H98fcSN'} });
    //0 = Jogando
    //  1 = Transmitindo
    //  2 = Ouvindo
    //  3 = Assistindo
...
//comando apagar
  if(comando === "apagar") {
    ...
    if(!deleteCount || deleteCount < 2 || deleteCount > 1000)
      return message.reply("Por favor, forneça um número entre 2 e 1000 para o número de mensagens a serem excluídas");
